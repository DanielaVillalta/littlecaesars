//Aqui en el controlador vamos a definir las funciones que ejecutarán los métodos get, post, put y delete
...
pizzasController.getLowStock = async (req, res) => {
  try {
    ...
    if (!pizzas) {
      return res.status(404).json({ message: "There are no pizzas with low stock" })
    }
